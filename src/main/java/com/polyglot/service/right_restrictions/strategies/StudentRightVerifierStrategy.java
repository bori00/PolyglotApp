...
/**
 * Class responsible for verifying whether a student has the right to access or modify certain data.
 */
public class StudentRightVerifierStrategy implements IRightVerifier {
    /** {@inheritDoc} */
    @Override
